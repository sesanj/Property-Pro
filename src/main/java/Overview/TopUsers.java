    ...
    public TopUsers(){
        ...
        try{
            ...
            while(data.next()){
                ...
                topClients.add(new TopClients(data.getString(CLIENT_FIRST_NAME), data.getString(CLIENT_LAST_NAME), data.getString(CLIENT_PHONE_NUMBER), data.getDouble("amountSpent")));
        ...
        userTable.getColumns().addAll(firstName, lastName, phoneNumber, amount);
