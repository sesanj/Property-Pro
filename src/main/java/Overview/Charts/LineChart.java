...
/**
 * Represents a line chart that displays monthly revenue data for the last 12 months.
 * The chart is populated with data fetched from the database and includes tooltips
 * for each data point showing revenue details and the corresponding date.
 */
public class LineChart extends BorderPane {

    /**
     * Constructs a LineChart and initializes the chart with revenue data from the database.
     ...
     * Tooltips are added to each data point for displaying detailed information when hovered over.
     *
     * @param db The Database object used to fetch the transaction data.
     */
    public LineChart(Database db){

        // Set up the X and Y axes for the line chart
        ...
        // Prepare the series to hold the data for the line chart
        ...
        // Add the series to the line chart and apply styles
        lineChart.getData().add(series);
        lineChart.getStylesheets().add(getClass().getResource("/cashFlow.css").toExternalForm());
        lineChart.setLegendVisible(false);

        // Set the line chart as the center of the layout
